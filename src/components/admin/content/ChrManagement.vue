<template>
  <div>
    ...
    <addChrmanagement @onSubmit="listChrmanagements()"></addChrmanagement>
...
<script>
  import addChrmanagement from './addChrmanagement'
    export default {
      name: 'Chrmanagement',
      components: {addChrmanagement},
      data () {
          return {
            chrmanagements: [],
      ...
      methods: {
        listChrmanagements () {
          var _this = this
          this.$axios.get('/admin/chrmanagement/list').then(resp => {
